<?php
// Admin Page for Social Icons Shortcode - 09-30-2012
...
<h3>Quick Start</h3>
<ul>
<li>1. Add this shortcode [iire_social_icons] to any post or page.</li>
<li>2. Go to "iiRe Social Icons", "Shortcode Settings".</li>
<li>3. In the Icons section, click an icon to add it to the Shortcode Designer.</li>
<li>4. Repeat the previous step to add additional icons.</li>
<li>5. Double-click each icon in the Shortcode Designer to edit the link and title.</li>
<li>6. Click "Icon Theme" in the side panel, choose a theme i.e. "Post It Notes" or use the "Default" theme.</li>
<li>7. Click "Save Changes".</li>
<li>8. Click "Preview" to view the output in the section where you placed the widget!</li>
