// IIRE SOCIAL WIDGET (Demo Version) - 04-03-2013
...
jQuery(document).ready(function() {
	...
	jQuery('li.choose').bind('click', function(e) {
		...
		switch(id) {
			case 'iire-email':	
				var addicon = '<div id="'+id+'"  class="move '+id+sz+' '+ac+'" sendemail" title="'+title+'" rel="nofollow" href="#"></div>';
				break;
			case 'iire-email2':	
	...
	jQuery('select#widget_responsive').bind('change', function(e) {
		var wrs = jQuery(this).val();
		if (wrs == '1') {
			jQuery("div#iire_social_widget").css("width", "85%");
			jQuery(".wrs").addClass("hidden");			
		} else {
			var w = jQuery("input#ww").val();			
			jQuery("div#iire_social_widget").css("width", w + "px");			
			jQuery(".wrs").removeClass("hidden");
		}
	});	
	...
	function adjustWidgetContainer() {
		...
		var wrs = jQuery("select#widget_responsive").val();
		if (wrs == '1') {
			jQuery("div#iire_social_widget").css("width", "85%");
			jQuery(".wrs").addClass("hidden");			
		}		
	...
	jQuery('select#link_title').bind('change', function() {
		...
		if (tit == '0') {
			jQuery("div#iire_social_widget div.move").attr('title', '');;
			updateTextAreas();
			var currenticons = jQuery('div#iire_social_widget').html();
			jQuery('textarea#widget_icons').val(currenticons);
			reorderIcons(currenticons);
	...
	jQuery('select#addthis').bind('change', function() {
		...
		if (addthis == '0') {
			...
			jQuery("div#iire_social_widget div#iire-addthis").remove();
	...
	jQuery('a.reset').bind('click', function() {
		if (confirm("Are you sure you want to clear your setting and start over?")) { 
			...
			jQuery('select#widget_icon_size').val('64');
			...
			jQuery('input#widget_roundedcorners_topright').val('6');			
			jQuery('input#widget_roundedcorners_bottomleft').val('6');
			jQuery('input#widget_roundedcorners_bottomright').val('6');	
			...
			jQuery('select#widget_responsive').val('0');			
